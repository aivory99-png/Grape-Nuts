            ...
            <div className="p-6 space-y-4">
              ...
              <section className="bg-app-bg/50 rounded-xl p-3">
                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="text-[9px] font-semibold text-app-text2 block mb-1">{lang === 'pt' ? 'Preço compra garrafa' : 'Precio compra garrafa'}</label>
                    ...
                    <div>
                      <label className="text-[9px] font-semibold text-app-text2 block mb-1">{lang === 'pt' ? 'Preço compra caixa' : 'Precio compra caixa'}</label>
                      <input type="number" min={0} step="0.01" value={mPurchasePrice} onChange={e => setMPurchasePrice(e.target.value)} className={inp} />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="text-[9px] font-semibold text-app-text2 block mb-1">{lang === 'pt' ? 'Preço venda garrafa' : 'Precio venta garrafa'}</label>
                    ...
                    <div>
                      <label className="text-[9px] font-semibold text-app-text2 block mb-1">{lang === 'pt' ? 'Preço venda caixa' : 'Precio venta caixa'}</label>
                      <input type="number" min={0} step="0.01" value={mListPrice} onChange={e => setMListPrice(e.target.value)} className={inp} />
                    </div>
                  </div>
                </div>
              </section>
