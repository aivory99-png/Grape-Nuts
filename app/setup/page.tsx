          ...
          <form action={action} className="space-y-4">
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-app-text2 mb-1.5">
                Contraseña * <span className="text-app-text3 font-normal">(mín. 6 caracteres)</span>
              </label>
              <input id="password" name="password" type="password" required minLength={6} className={inp} />
            </div>
